...
const QUIZ = [
  { q: "钻石在哪个 Y 坐标最容易找到？", a: "Y=-59 附近" },
  { q: "下界合金和钻石哪个更耐用？", a: "下界合金" },
  { q: "在下界睡觉会发生什么？", a: "床会爆炸" },
  { q: "什么生物怕猫？", a: "苦力怕和幻翼" },
  { q: "末影人为什么攻击你？", a: "因为你看了它的眼睛" },
  { q: "附魔台周围放多少个书架能升到 30 级？", a: "15 个" },
  { q: "铁傀儡用什么合成？", a: "4 个铁块 + 1 个南瓜" },
  { q: "什么可以解除所有负面效果？", a: "牛奶" },
  { q: "信标需要什么才能激活？", a: "金字塔底座 + 下界之星" },
  { q: "鞘翅需要什么才能飞得远？", a: "烟花火箭" },
  { q: "苦力怕被闪电劈中会变成什么？", a: "高压苦力怕" },
  { q: "凋灵 Boss 需要什么召唤？", a: "4 个灵魂沙 + 3 个凋灵骷髅头" },
  { q: "末影龙蛋怎么收集？", a: "用活塞推或火把烧" },
  { q: "潜影贝的壳能做什么？", a: "潜影盒" },
  { q: "潮涌核心需要什么激活？", a: "海晶石 + 鹦鹉螺壳" },
  { q: "熊猫会做什么搞笑的事？", a: "打喷嚏吓到附近的熊猫" },
  { q: "海龟蛋在什么方块上才能孵化？", a: "沙子或红沙" },
  { q: "美西螈有什么特殊能力？", a: "水下呼吸，装死" },
  { q: "青蛙吃小史莱姆会掉落什么？", a: "黏液球" },
  { q: "山羊会做什么危险的事？", a: "把你撞下悬崖" },
  { q: "铜块会随时间发生什么变化？", a: "氧化变绿" },
  { q: "避雷针的作用是什么？", a: "吸引闪电，保护建筑" },
  { q: "望远镜有什么用？", a: "放大远处视野" },
  { q: "发光鱿鱼有什么特点？", a: "在黑暗中发光" },
  { q: "深板岩和普通石头哪个更硬？", a: "深板岩" },
  { q: "末影箱里的东西谁能取？", a: "自己，全世界都能取" },
  { q: "蜘蛛网有什么用？", a: "减缓下落速度，救命" },
  { q: "灵魂沙有什么效果？", a: "减速，但可以做气泡柱" },
  { q: "命名牌有什么用？", a: "让生物永久保留名字" },
  { q: "钓鱼能钓到什么稀有物品？", a: "附魔书，甚至是宝藏" },
  { q: "雪傀儡会在什么环境融化？", a: "温暖生物群系" },
  { q: "铁砧掉下来会怎样？", a: "砸伤你" },
  { q: "金锭能做什么特殊轨道？", a: "Powered Rail（动力铁轨）" },
  { q: "羊被剪毛后需要什么才能重新长毛？", a: "吃草" },
  { q: "猪可以用什么骑？", a: "胡萝卜钓竿" },
  { q: "狼用什么驯服？", a: "骨头" },
  { q: "猫能吓跑什么生物？", a: "苦力怕和幻翼" },
  { q: "村民交易怎么打折？", a: "治好僵尸村民" },
  { q: "睡觉会失去什么机会？", a: "刷怪的机会" },
  { q: "凋灵骷髅头能做什么？", a: "召唤凋灵 Boss" },
  { q: "熔炉可以用什么做燃料？", a: "煤炭、木炭或岩浆桶" },
  { q: "火把能阻止什么？", a: "怪物在附近生成" },
  { q: "骨粉有什么用？", a: "让作物快速生长" },
  { q: "鸡蛋扔出去有几率生成什么？", a: "小鸡（1/8 几率）" },
  { q: "钻石镐能挖什么特殊方块？", a: "黑曜石" },
  { q: "床在下界会怎样？", a: "爆炸" },
  { q: "末影珍珠有什么副作用？", a: "瞬移后扣血" },
  { q: "金苹果有什么作用？", a: "紧急时刻回血" },
  { q: "鞘翅怎么获得？", a: "击败末影龙后从末地船获得" },
  { q: "远古城市的监守者怎么触发？", a: "发出声音或踩到尖啸体" },
];
