 ...
 *
 * 模块划分（本文件只保留路由分发与页面渲染）：
 *   _lib/admin-util.js    常量、Cookie、安全响应头、转义与格式化工具
 *   _lib/admin-theme.js   主题脚本 / 样式表 / 登录页
 *   _lib/admin-api.js     Cloudflare GraphQL 与用量查询
 */
...
} from "./_lib/admin-util.js";
import { THEME_SCRIPT, THEME_CSS, loginPage } from "./_lib/admin-theme.js";
import { cfGraphQL, fetchUsageSplit } from "./_lib/admin-api.js";
