        ...
        <StackPanel Margin="25,40,23,16">
                ...
                <Grid>
                        ...
                        <StackPanel>
                            <StackPanel Orientation="Horizontal">
                                <Border Width="26" Height="26" CornerRadius="13" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center">
                                    <local:MyImage Width="16" Height="16" HorizontalAlignment="Center" VerticalAlignment="Center" Source="/images/icons/player.png" />
                                </Border>
                    ...
                    <StackPanel VerticalAlignment="Bottom" Margin="20,0,16,12" HorizontalAlignment="Center">
                        <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,4">
                            <local:MyImage Width="16" Height="16" Margin="0,0,6,0" VerticalAlignment="Center" Source="/images/icons/book.png" />
            ...
            <Grid>
                    ...
                    <Grid>
                        <StackPanel>
                            <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,8">
                                <local:MyImage Width="16" Height="16" Margin="0,0,4,0" VerticalAlignment="Center" Source="/images/icons/gold.png" />
                ...
                <Border Grid.Column="1" CornerRadius="10" Padding="16,16" Margin="6,0,0,0" Background="{DynamicResource ColorBrush7}">
                    <StackPanel>
                        <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,8">
                            <local:MyImage Width="16" Height="16" Margin="0,0,4,0" VerticalAlignment="Center" Source="/images/icons/palette.png" />
            ...
            <Border CornerRadius="10" Padding="18,16" Margin="0,0,0,12" Background="{DynamicResource ColorBrush7}">
                <StackPanel>
                    <Grid Margin="0,0,0,12">
                        ...
                        <local:MyImage Grid.Column="0" Width="22" Height="22" Margin="0,0,12,0" VerticalAlignment="Center" Source="/images/icons/player.png" />
                    ...
                    <Grid>
                        ...
                        <local:MyImage Grid.Column="0" Width="22" Height="22" Margin="0,0,12,0" VerticalAlignment="Center" Source="/images/icons/globe.png" />
                        <StackPanel Grid.Column="1" VerticalAlignment="Center">
...
{{RELEASE_ITEMS}}
    ...
    <local:MyCard Title="今日运势" Margin="0,0,0,12" CanSwap="True" IsSwapped="False">
        <StackPanel Margin="25,40,23,16">
            ...
            <Border CornerRadius="10" Padding="16,16" Margin="0,0,0,12" Background="{DynamicResource ColorBrush7}">
                <StackPanel Orientation="Horizontal">
                    <local:MyImage Width="36" Height="36" Margin="0,0,12,0" VerticalAlignment="Center" Source="/images/icons/clover.png" />
            ...
            <Border CornerRadius="12" Height="150" Margin="0,0,0,12" Background="{DynamicResource ColorBrush7}">
                <Grid Margin="18,0">
                    <StackPanel Orientation="Horizontal" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="0,16,0,0">
                        <local:MyImage Width="16" Height="16" Margin="0,0,4,0" VerticalAlignment="Center" Source="/images/icons/compass.png" />
    ...
    <local:MyCard Title="更多功能" Margin="0,0,0,12" CanSwap="True" IsSwapped="False">
        <StackPanel Margin="25,40,23,16">
            <local:MyListItem Margin="-5,0,-5,8" Type="Clickable" Logo="/images/icons/compass.png" Title="打开更多功能" Info="MC 知识 · 实用工具 · 服务器推荐" EventType="打开帮助" EventData="{{BASE_URL}}/panel.json" />
