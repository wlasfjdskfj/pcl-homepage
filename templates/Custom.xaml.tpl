<StackPanel>
    ...
    <local:MyCard Title="更多" Margin="0,0,0,16" CanSwap="True" IsSwapped="True">
        <StackPanel Margin="25,40,23,16">
            ...
            <local:MyListItem Margin="-5,0,-5,8" Type="Clickable" Logo="pack://application:,,,/images/Blocks/RedstoneLampOn.png" Title="打开更多功能" Info="MC 知识 · 实用工具" EventType="打开帮助" EventData="{{BASE_URL}}/panel.json" />
            <Grid Margin="0,4,0,0">
                <Grid.ColumnDefinitions>
                    <ColumnDefinition Width="1*" />
                    <ColumnDefinition Width="1*" />
