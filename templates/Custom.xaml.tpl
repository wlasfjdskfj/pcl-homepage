<StackPanel>
    <StackPanel.Resources>
        ...
        <!-- 入场淡入：一份 Storyboard 复用，各元素用自己的 Loaded 触发器引用。
             用共享资源是为了避免给每个元素起 x:Name（易写错）。 -->
        <Storyboard x:Key="FadeInOnce">
        ...
        <StackPanel Margin="25,40,23,16">
            <StackPanel.Triggers>
                <EventTrigger RoutedEvent="StackPanel.Loaded">
                    <BeginStoryboard Storyboard="{StaticResource FadeInOnce}" />
                </EventTrigger>
            </StackPanel.Triggers>
            <!-- __FESTIVAL_BANNER__ -->
    ...
    <local:MyCard Title="你的信息" Margin="0,0,0,12" CanSwap="True" IsSwapped="False">
        <StackPanel Margin="25,40,23,16">
            <StackPanel.Triggers>
                <EventTrigger RoutedEvent="StackPanel.Loaded">
                    <BeginStoryboard Storyboard="{StaticResource FadeInOnce}" BeginTime="0:0:0.1" />
                </EventTrigger>
            </StackPanel.Triggers>
    ...
    <local:MyCard Title="今日运势" Margin="0,0,0,12" CanSwap="True" IsSwapped="False">
        <StackPanel Margin="25,40,23,16">
            <StackPanel.Triggers>
                <EventTrigger RoutedEvent="StackPanel.Loaded">
                    <BeginStoryboard Storyboard="{StaticResource FadeInOnce}" BeginTime="0:0:0.2" />
                </EventTrigger>
            </StackPanel.Triggers>
    ...
    <local:MyCard Title="更多" Margin="0,0,0,12" CanSwap="True" IsSwapped="False">
        <StackPanel Margin="25,40,23,16">
            <StackPanel.Triggers>
                <EventTrigger RoutedEvent="StackPanel.Loaded">
                    <BeginStoryboard Storyboard="{StaticResource FadeInOnce}" BeginTime="0:0:0.3" />
                </EventTrigger>
            </StackPanel.Triggers>
