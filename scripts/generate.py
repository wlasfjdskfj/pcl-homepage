...
def build_xaml():
    ...
    lines.append('            <Border CornerRadius="12" Height="300" Margin="0,0,0,16" ClipToBounds="True" BorderBrush="#33FFFFFF" BorderThickness="1">')
    lines.append('                <Grid>')
    ...
    lines.append('                                <GradientStop Color="#4D000000" Offset="0" />')
    lines.append('                                <GradientStop Color="#66000000" Offset="0.45" />')
    lines.append('                                <GradientStop Color="#B3000000" Offset="0.75" />')
    lines.append('                                <GradientStop Color="#E6000000" Offset="1" />')
    lines.append('                            </LinearGradientBrush>')
    lines.append('                        </Border.Background>')
    lines.append('                    </Border>')

    lines.append('                    <Border HorizontalAlignment="Left" VerticalAlignment="Top" Margin="18,16,0,0" Background="#66000000" CornerRadius="16" BorderBrush="#40FFFFFF" BorderThickness="1" Padding="14,11,18,11">')
    lines.append('                        <StackPanel>')
    lines.append('                            <StackPanel Orientation="Horizontal">')
    lines.append('                                <Border Width="30" Height="30" CornerRadius="15" Background="{DynamicResource ColorBrush1}" BorderBrush="#55FFFFFF" BorderThickness="1" Margin="0,0,10,0" VerticalAlignment="Center">')
    lines.append('                                    <local:MyImage Width="19" Height="19" HorizontalAlignment="Center" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/Grass.png" />')
    lines.append('                                </Border>')
    lines.append('                                <StackPanel VerticalAlignment="Center">')
    lines.append('                                    <TextBlock Text="' + greeting + '，{user}！" FontSize="15" FontWeight="Bold" Foreground="White" />')
    lines.append('                                    <TextBlock Text="欢迎回来，今天也一起去冒险吧。" FontSize="11.5" Foreground="#E0FFFFFF" Margin="0,3,0,0" />')
    lines.append('                                </StackPanel>')
    lines.append('                            </StackPanel>')
    lines.append('                        </StackPanel>')
    lines.append('                    </Border>')

    lines.append('                    <Border HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,18,16" Background="#33000000" CornerRadius="9" Padding="10,5,10,5">')
    lines.append('                        <TextBlock FontSize="11" FontWeight="Bold" Foreground="#D9FFFFFF" Text="' + year + ' · ' + month + ' / ' + day + '" />')
    lines.append('                    </Border>')
    ...
    lines.append('                            <Grid>')
    lines.append('                                <TextBlock Text="' + month + '" FontSize="60" FontWeight="Bold" Foreground="#66000000" Margin="0,4,0,0" />')
    ...
    lines.append('                            <Grid>')
    lines.append('                                <TextBlock Text="' + day + '" FontSize="60" FontWeight="Bold" Foreground="#66000000" Margin="0,4,0,0" />')
    ...
    lines.append('                        </StackPanel>')
    lines.append('                        <Grid>')
    lines.append('                            <TextBlock Text="星期' + weekday + '" HorizontalAlignment="Center" FontSize="13" FontWeight="Bold" Foreground="#66000000" Margin="0,2,0,0" />')
    lines.append('                            <TextBlock Text="星期' + weekday + '" HorizontalAlignment="Center" FontSize="13" FontWeight="Bold" Foreground="#EEFFFFFF" />')
    lines.append('                        </Grid>')
    lines.append('                        <Border Width="26" Height="2" CornerRadius="1" Background="{DynamicResource ColorBrush1}" HorizontalAlignment="Center" Margin="0,9,0,0" Opacity="0.9" />')
    lines.append('                    </StackPanel>')

    lines.append('                    <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" VerticalAlignment="Bottom" Margin="0,0,0,10" Opacity="0.6">')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Grass.png">')
    lines.append('                            <local:MyImage.RenderTransform>')
    lines.append('                                <TranslateTransform Y="-4" />')
    lines.append('                            </local:MyImage.RenderTransform>')
    lines.append('                        </local:MyImage>')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Dirt.png" Margin="1,0,0,0" />')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Stone.png">')
    lines.append('                            <local:MyImage.RenderTransform>')
    lines.append('                                <TranslateTransform Y="-3" />')
    lines.append('                            </local:MyImage.RenderTransform>')
    lines.append('                        </local:MyImage>')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Grass.png">')
    lines.append('                            <local:MyImage.RenderTransform>')
    lines.append('                                <TranslateTransform Y="-1" />')
    lines.append('                            </local:MyImage.RenderTransform>')
    lines.append('                        </local:MyImage>')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Dirt.png" Margin="1,0,0,0" />')
    lines.append('                        <local:MyImage Width="17" Height="17" Source="pack://application:,,,/images/Blocks/Stone.png">')
    lines.append('                            <local:MyImage.RenderTransform>')
    lines.append('                                <TranslateTransform Y="-5" />')
    lines.append('                            </local:MyImage.RenderTransform>')
    lines.append('                        </local:MyImage>')
    lines.append('                    </StackPanel>')

    lines.append('                    <Border Height="3" HorizontalAlignment="Stretch" VerticalAlignment="Bottom" Background="{DynamicResource ColorBrush1}" Opacity="0.35" />')
    lines.append('                </Grid>')
    lines.append('            </Border>')
    ...
    lines.append('                    <Grid>')
    lines.append('                        <TextBlock Text="' + str(lucky_number) + '" FontSize="100" FontWeight="Bold" Foreground="{DynamicResource ColorBrush1}" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-10,8" Opacity="0.05" />')
    lines.append('                        <StackPanel>')
    ...
    lines.append('                            </StackPanel>')
    lines.append('                            <TextBlock Text="' + str(lucky_number) + '" FontSize="38" FontWeight="Bold" HorizontalAlignment="Center" Foreground="{DynamicResource ColorBrush1}" />')
    lines.append('                            <Border Width="22" Height="2" CornerRadius="1" Background="{DynamicResource ColorBrush1}" HorizontalAlignment="Center" Margin="0,6,0,0" Opacity="0.5" />')
    lines.append('                        </StackPanel>')
    lines.append('                    </Grid>')
    lines.append('                </Border>')

    lines.append('                <Border Grid.Column="1" CornerRadius="10" Padding="16,14" Margin="6,0,0,0" Background="{DynamicResource ColorBrush7}" ClipToBounds="True">')
    lines.append('                    <Grid>')
    lines.append('                        <Border CornerRadius="10" Background="' + lucky_color["hex"] + '" Opacity="0.08" />')
    lines.append('                        <StackPanel>')
    lines.append('                            <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,8">')
    ...
    lines.append('                            </StackPanel>')
    lines.append('                            <StackPanel Orientation="Horizontal" HorizontalAlignment="Center">')
    lines.append('                                <Grid Width="36" Height="36" Margin="0,0,12,0" VerticalAlignment="Center">')
    lines.append('                                    <Border CornerRadius="18" Background="' + lucky_color["hex"] + '" Margin="2" />')
    lines.append('                                    <Border CornerRadius="18" BorderBrush="' + lucky_color["hex"] + '" BorderThickness="3" Opacity="0.45" />')
    lines.append('                                    <Border CornerRadius="18" BorderBrush="#44FFFFFF" BorderThickness="1" Margin="2" />')
    lines.append('                                    <Ellipse Width="9" Height="9" Fill="#55FFFFFF" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="7,7,0,0" />')
    lines.append('                                </Grid>')
    lines.append('                                <StackPanel VerticalAlignment="Center">')
    lines.append('                                    <TextBlock Text="' + lucky_color["name"] + '" FontSize="16" FontWeight="Bold" Foreground="{DynamicResource ColorBrush1}" />')
    lines.append('                                    <TextBlock Text="今日吉色" FontSize="10.5" Foreground="{DynamicResource ColorBrush3}" Margin="0,2,0,0" />')
    lines.append('                                </StackPanel>')
    lines.append('                            </StackPanel>')
    lines.append('                        </StackPanel>')
    lines.append('                    </Grid>')
    ...
    # 主推服务器大卡
    lines.append('            <Border CornerRadius="10" Padding="18,16" Margin="0,0,0,14" Background="{DynamicResource ColorBrush7}" ClipToBounds="True">')
    lines.append('                <Grid>')
    lines.append('                    <local:MyImage Width="88" Height="88" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-12,-8" Opacity="0.07" Source="pack://application:,,,/images/Blocks/Grass.png" />')
    lines.append('                    <StackPanel>')
    lines.append('                        <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,10">')
    lines.append('                            <Border Width="18" Height="18" CornerRadius="4" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center">')
    lines.append('                                <local:MyImage Width="12" Height="12" HorizontalAlignment="Center" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/Grass.png" />')
    lines.append('                            </Border>')
    lines.append('                            <TextBlock Text="主推服务器" FontSize="11" FontWeight="Bold" Foreground="{DynamicResource ColorBrush3}" VerticalAlignment="Center" />')
    lines.append('                        </StackPanel>')
    lines.append('                        <TextBlock Text="' + server_address + '" FontSize="24" FontWeight="Bold" HorizontalAlignment="Center" Foreground="{DynamicResource ColorBrush1}" Margin="0,0,0,14" />')
    lines.append('                        <Border Width="40" Height="2" CornerRadius="1" Background="{DynamicResource ColorBrush1}" HorizontalAlignment="Center" Margin="0,0,0,14" Opacity="0.4" />')
    ...
    lines.append('            <Border CornerRadius="10" Padding="18,16" Margin="0,0,0,14" Background="{DynamicResource ColorBrush7}" ClipToBounds="True">')
    lines.append('                <Grid>')
    lines.append('                    <local:MyImage Width="96" Height="96" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="0,-14,-10,0" Opacity="0.06" Source="pack://application:,,,/images/Blocks/CommandBlock.png" />')
    lines.append('                    <StackPanel>')
    lines.append('                        <StackPanel Orientation="Horizontal" Margin="0,0,0,12">')
    lines.append('                            <Border Width="34" Height="34" CornerRadius="17" Background="{DynamicResource ColorBrush1}" BorderBrush="#33FFFFFF" BorderThickness="1" Margin="0,0,14,0" VerticalAlignment="Center">')
    lines.append('                                <local:MyImage Width="20" Height="20" HorizontalAlignment="Center" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/Grass.png" />')
    lines.append('                            </Border>')
    lines.append('                            <StackPanel VerticalAlignment="Center">')
    lines.append('                                <TextBlock Text="玩家 ID" FontSize="11" Foreground="{DynamicResource ColorBrush3}" />')
    lines.append('                                <TextBlock Text="{user}" FontSize="16" FontWeight="Bold" Foreground="{DynamicResource ColorBrush1}" Margin="0,2,0,0" />')
    ...
    lines.append('                        <StackPanel Orientation="Horizontal">')
    lines.append('                            <local:MyImage Width="22" Height="22" Margin="0,0,14,0" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/RedstoneBlock.png" />')
    lines.append('                            <StackPanel VerticalAlignment="Center">')
    ...
    lines.append('                        </Border.Background>')
    lines.append('                    </Border>')
    lines.append('                    <local:MyImage Width="132" Height="132" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-20,-18" Opacity="0.12" Source="pack://application:,,,/images/Blocks/CommandBlock.png" />')
    ...
    lines.append('                    <Border Height="3" VerticalAlignment="Bottom" Background="{DynamicResource ColorBrush1}" Opacity="0.35" />')
    lines.append('                </Grid>')
    lines.append('            </Border>')
    ...
    lines.append('            <StackPanel Orientation="Horizontal" Margin="0,0,0,10">')
    lines.append('                <local:MyImage Width="15" Height="15" Margin="0,0,7,0" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/Stone.png" />')
    lines.append('                <Border Width="3" Height="12" CornerRadius="1.5" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center" />')
    ...
    lines.append('            <Border Height="1" Background="{DynamicResource ColorBrush6}" Margin="0,0,0,14" />')
    lines.append('            <StackPanel Orientation="Horizontal" Margin="0,0,0,10">')
    lines.append('                <local:MyImage Width="15" Height="15" Margin="0,0,7,0" VerticalAlignment="Center" Source="pack://application:,,,/images/Blocks/Bookshelf.png" />')
    lines.append('                <Border Width="3" Height="12" CornerRadius="1.5" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center" />')
    ...
    lines.append('        <StackPanel Margin="25,40,23,20">')
    lines.append('            <Border CornerRadius="10" Padding="16,14" Margin="0,0,0,14" Background="{DynamicResource ColorBrush7}" ClipToBounds="True">')
    lines.append('                <Grid>')
    lines.append('                    <local:MyImage Width="72" Height="72" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-10,-8" Opacity="0.07" Source="pack://application:,,,/images/Blocks/Grass.png" />')
    lines.append('                    <StackPanel Orientation="Horizontal">')
