...
def build_xaml():
    ...
    lines.append('                            <Path Data="M180 540l120 120 240-240" Stroke="#17DD62" StrokeThickness="40" StrokeStartLineCap="Round" StrokeEndLineCap="Round" Width="14" Height="14" Stretch="Uniform" Margin="0,0,6,0" />')
    ...
    lines.append('                    <StackPanel>')
    lines.append('                        <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,6">')
    lines.append('                            <Path Data="M200 200 L800 800 M800 200 L200 800" Stroke="#FF5555" StrokeThickness="40" StrokeStartLineCap="Round" StrokeEndLineCap="Round" Width="14" Height="14" Stretch="Uniform" Margin="0,0,6,0" />')
