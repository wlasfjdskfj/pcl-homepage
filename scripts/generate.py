...
def build_xaml():
    ...
    lines.append('                <local:MyIconTextButton Grid.Column="2" Text="WIKI" LogoScale="0.9" Logo="M192 128h448c53 0 96 43 96 96v640H288c-53 0-96-43-96-96V128z" EventType="打开网页" EventData="' + wiki_url + '" />')
