...
def build_panel_xaml(server_list):
    ...
    p.append('               FontSize="26" FontWeight="Bold"')
    p.append('               HorizontalAlignment="Center"')
    p.append('               Margin="0,12,0,14">')
    ...
    p.append('                            <LinearColorKeyFrame Value="#A371F7" KeyTime="0:0:1.5" />')
    p.append('                            <LinearColorKeyFrame Value="#F778BA" KeyTime="0:0:3" />')
    p.append('                            <LinearColorKeyFrame Value="#3FB950" KeyTime="0:0:4.5" />')
    p.append('                            <LinearColorKeyFrame Value="#E3B341" KeyTime="0:0:6" />')
    p.append('                            <LinearColorKeyFrame Value="#58A6FF" KeyTime="0:0:7.5" />')
    p.append('                        </ColorAnimationUsingKeyFrames>')
    p.append('                    </Storyboard>')
    p.append('                </BeginStoryboard>')
    ...
    p.append('            </local:MyIconTextButton>')
    # 神秘彩蛋横幅
    p.append('            <Border Height="1" Margin="0,18,0,14"><Border.Background><LinearGradientBrush StartPoint="0,0" EndPoint="1,0"><GradientStop Color="#00555555" Offset="0" /><GradientStop Color="#55555555" Offset="0.5" /><GradientStop Color="#00555555" Offset="1" /></LinearGradientBrush></Border.Background></Border>')
    p.append('            <Border CornerRadius="12" Margin="0,0,0,12" ClipToBounds="True">')
    p.append('                <Border.Background>')
    p.append('                    <LinearGradientBrush StartPoint="0,0" EndPoint="1,1">')
    p.append('                        <GradientStop Color="#5B21B6" Offset="0" />')
    p.append('                        <GradientStop Color="#9333EA" Offset="0.5" />')
    p.append('                        <GradientStop Color="#F59E0B" Offset="1" />')
    p.append('                    </LinearGradientBrush>')
    p.append('                </Border.Background>')
    ...
    p.append('                        <TextBlock Text="神秘彩蛋" FontSize="15" FontWeight="Bold" Foreground="#FFFFFF" />')
    p.append('                        <TextBlock Text="今天属于你的彩蛋，明天自动换新" FontSize="10" Foreground="#D9FFFFFF" Margin="0,4,0,0" />')
    p.append('                    </StackPanel>')
    p.append('                    <Grid Grid.Column="1" Width="46" Height="46" VerticalAlignment="Center">')
    p.append('                        <Border CornerRadius="23" Background="#33FFFFFF" />')
    p.append('                        <local:MyImage Width="30" Height="30" Source="pack://application:,,,/images/Blocks/Egg.png" />')
    p.append('                    </Grid>')
    p.append('                </Grid>')
    p.append('            </Border>')
    ...
    p.append('            <Border Height="1" Margin="0,14,0,14"><Border.Background><LinearGradientBrush StartPoint="0,0" EndPoint="1,0"><GradientStop Color="#00555555" Offset="0" /><GradientStop Color="#55555555" Offset="0.5" /><GradientStop Color="#00555555" Offset="1" /></LinearGradientBrush></Border.Background></Border>')
    for group_idx, (group_title, cmds) in enumerate(CMD_GROUPS):
        ...
        p.append('                <StackPanel>')
        p.append('                    <Border CornerRadius="6" Padding="8,3" Margin="0,0,0,10">')
        p.append('                        <Border.Background><SolidColorBrush Color="#15FFFFFF" /></Border.Background>')
        p.append('                        <StackPanel Orientation="Horizontal">')
        p.append('                            <Border Width="3" Height="10" CornerRadius="1.5" Background="' + bar_color + '" Margin="0,0,8,0" VerticalAlignment="Center" />')
        p.append('                            <TextBlock Text="' + group_title + '" FontSize="11" FontWeight="Bold" Foreground="' + bar_color + '" VerticalAlignment="Center" />')
        p.append('                        </StackPanel>')
        p.append('                    </Border>')
        p.append('                    <Grid>')
        p.append('                        <Grid.ColumnDefinitions>')
    ...
    p.append('                <Border.Background><SolidColorBrush Color="#15FFFFFF" /></Border.Background>')
    p.append('                <StackPanel Orientation="Horizontal">')
    p.append('                    <Border Width="3" Height="9" CornerRadius="1.5" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center" />')
    p.append('                    <TextBlock Text="其他服务器" FontSize="11" FontWeight="Bold" Foreground="{DynamicResource ColorBrush3}" VerticalAlignment="Center" />')
    p.append('                </StackPanel>')
    p.append('            </Border>')
...
def build_xaml():
    ...
    lines.append('                <StackPanel Orientation="Horizontal">')
    lines.append('                    <Border Width="3" Height="9" CornerRadius="1.5" Background="{DynamicResource ColorBrush1}" Margin="0,0,8,0" VerticalAlignment="Center" />')
    ...
    lines.append('                <TextBlock Text="' + str(score) + '" FontSize="56" FontWeight="Bold" Foreground="__SCORE_COLOR__" />')
    ...
    lines.append('                <TextBlock Text="' + grade + '" FontSize="18" FontWeight="Bold" Foreground="__SCORE_COLOR__" />')
    lines.append('            </StackPanel>')
    lines.append('            <Grid Margin="0,0,0,12">')
    lines.append('                <Grid.ColumnDefinitions>')
    lines.append('                    <ColumnDefinition Width="1*" />')
    lines.append('                    <ColumnDefinition Width="1*" />')
    lines.append('                </Grid.ColumnDefinitions>')
    lines.append('                <Border Grid.Column="0" CornerRadius="10" Padding="14,12" Margin="0,0,6,0">')
    lines.append('                    <Border.Background>')
    lines.append('                        <LinearGradientBrush StartPoint="0,0" EndPoint="0,1">')
    lines.append('                            <GradientStop Color="#2A17DD62" Offset="0" />')
    lines.append('                            <GradientStop Color="#1217DD62" Offset="1" />')
    lines.append('                        </LinearGradientBrush>')
    lines.append('                    </Border.Background>')
    lines.append('                    <StackPanel>')
    ...
    lines.append('                                <Ellipse Fill="#17DD62" />')
    lines.append('                                <Path Data="M382 732L160 510l-72 72 294 294 576-576-72-72z" Fill="White" Stretch="Uniform" Margin="4" />')
    lines.append('                            </Grid>')
    lines.append('                            <TextBlock Text="宜" FontSize="12" FontWeight="Bold" Foreground="#17DD62" VerticalAlignment="Center" />')
    lines.append('                        </StackPanel>')
    lines.append('                        <TextBlock Text="' + fortune_good + '" FontSize="15" FontWeight="Bold" HorizontalAlignment="Center" Foreground="#17DD62" />')
    lines.append('                    </StackPanel>')
    lines.append('                </Border>')
    lines.append('                <Border Grid.Column="1" CornerRadius="10" Padding="14,12" Margin="6,0,0,0">')
    lines.append('                    <Border.Background>')
    lines.append('                        <LinearGradientBrush StartPoint="0,0" EndPoint="0,1">')
    lines.append('                            <GradientStop Color="#2AFF5555" Offset="0" />')
    lines.append('                            <GradientStop Color="#12FF5555" Offset="1" />')
    lines.append('                        </LinearGradientBrush>')
    lines.append('                    </Border.Background>')
    lines.append('                    <StackPanel>')
    lines.append('                        <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" Margin="0,0,0,6">')
    lines.append('                            <Grid Width="20" Height="20" Margin="0,0,7,0" VerticalAlignment="Center">')
    lines.append('                                <Ellipse Fill="#FF5555" />')
    ...
    lines.append('                            </Grid>')
    lines.append('                            <TextBlock Text="忌" FontSize="12" FontWeight="Bold" Foreground="#FF5555" VerticalAlignment="Center" />')
    lines.append('                        </StackPanel>')
